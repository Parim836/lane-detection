...
โปรเจกต์นี้เป็นระบบตรวจจับและแก้ไขจำนวนเลนถนน โดยใช้ภาพจาก Google Street View และข้อมูลจาก OpenStreetMap (OSM) ซึ่งมีการจัดโครงสร้างไฟล์ตามหน้าที่ดังนี้:
