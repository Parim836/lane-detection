...
class VGG16FCN(cnn_basenet.CNNBaseModel):
    ...
    def _vgg16_fcn_encode(self, input_tensor, name):
        ...
        with tf.variable_scope(name_or_scope=name):
            ...
            # freeze
            # conv_1_1 = tf.stop_gradient(conv_1_1)
            ...
            # freeze
            # conv_1_2 = tf.stop_gradient(conv_1_2)
            ...
            #freeze
            # conv_2_1 = tf.stop_gradiant(conv_2_1)
            ...
            #freeze
            # conv_2_2 = tf.stop_gradiant(conv_2_2)
        ...
        # conv_1_1 = tf.stop_gradient(conv_1_1)
        # conv_1_2 = tf.stop_gradient(conv_1_2)
        # conv_2_1 = tf.stop_gradient(conv_2_1)
        # conv_2_2 = tf.stop_gradient(conv_2_2)
        # conv_3_1 = tf.stop_gradient(conv_3_1)
        # conv_3_2 = tf.stop_gradient(conv_3_2)
        # conv_3_3 = tf.stop_gradient(conv_3_3)
        # conv_4_1 = tf.stop_gradient(conv_4_1)
        # conv_4_2 = tf.stop_gradient(conv_4_2)
        # conv_4_3 = tf.stop_gradient(conv_4_3)
        # conv_5_1_binary = tf.stop_gradient(conv_5_1_binary)
        # conv_5_2_binary = tf.stop_gradient(conv_5_2_binary)
        # conv_5_3_binary = tf.stop_gradient(conv_5_3_binary)
        # conv_5_1_instance = tf.stop_gradient(conv_5_1_instance)
        # conv_5_2_instance = tf.stop_gradient(conv_5_2_instance)
        # conv_5_3_instance = tf.stop_gradient(conv_5_3_instance)  
